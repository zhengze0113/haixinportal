...
<template>
    <div>
    <el-row :gutter="20">
        <el-col :span="4"><div class="grid-content bg-purple"><h4>镜像列表</h4></div></el-col>
        <el-col :span="20" >
          <div class="grid-content bg-purple" style="float: right;">
            <el-select v-model="value" placeholder="环境下拉框">
              <el-option
            ...
            <el-input style="width: 250px;" v-model="input" suffix-icon="el-icon-search" placeholder="请输入内容"/>
            <el-button-group>
              <el-button><svg-icon icon-class="upload"/>
              上传</el-button>
              <el-button><svg-icon icon-class="download"/>
              下载</el-button>
              <el-button><svg-icon icon-class="deploy_btn"/>
              部署</el-button>
...
size="small"
      ...
      width="55">
                ...
                <template slot-scope="scope">
                    <router-link :to="{path: '/asset/image/detail/'+scope.row.id}" class="link">{{ scope.row.title }}</router-link>
                </template>
                </el-table-column>
