...
<template>
    <div>
    <el-row :gutter="20">
        <el-col :span="4"><div class="grid-content bg-purple"><h4>文件列表</h4></div></el-col>
        <el-col :span="20" ><div class="grid-content bg-purple" style="float: right;">
            <el-input style="width: 150px;" v-model="input" suffix-icon="el-icon-search" placeholder="请输入内容"></el-input>
            <el-button-group>
              <el-button>
...
size="small"
      ...
      width="55">
                ...
                <el-table-column label="Dockerfile名称">
