      ...
      <el-col :span="20">
        <div class="grid-content bg-purple" style="float: right;">
          ...
          <el-button-group>
            ...
            <el-button>
              <svg-icon icon-class="upload"/>上传
            </el-button>
            <el-button>
              <svg-icon icon-class="download"/>下载
            </el-button>
            <el-button>
              <svg-icon icon-class="form"/>编辑
            </el-button>
            <el-button>
              <svg-icon icon-class="deploy_btn"/>部署
            </el-button>
            <el-button>
...
size="small"
    ...
    >
      ...
      <el-table-column label="云盘名称">
        <template slot-scope="scope">
          <router-link
            :to="{path: '/asset/container/yaml/'+scope.row.title}"
            class="link"
