    ...
    <el-row :gutter="20">
      <el-col :span="24" :offset="0">
        <div class="grid-content bg-purple">
          <close-card :show-arrow="true" title="租户机构列表" icon="list">
            <div class="right">
              <el-input
                v-model="searchInput"
                placeholder="请输入内容"
            ...
            >
              ...
              <el-table-column label="名称" width="110" align="center">
                <template slot-scope="scope">
                  <router-link :to="{path: '/tenementCentre/organizationUser/tenementOrganization/detail/'+scope.row.id}" class="link">{{ scope.row.displayName }}</router-link>
              ...
              <el-table-column label="网站" width="110" align="center">
                <template slot-scope="scope">
              ...
              <el-table-column
                ...
                <template slot-scope="scope">
                  <div class="table-operator">
                    ...
                    <el-dropdown szie="small" class="operator-dropdown" @command="deleteOrganization">
        ...
        <el-col :span="20" :offset="2"><div class="grid-content bg-purple">
          <el-form :inline="true" :model="organization" class="demo-form-inline" >
            <el-form-item label="名称">
              <el-input v-model="organization.name" placeholder="名称"/>
            </el-form-item>
            <el-form-item label="显示名称">
              <el-input v-model="organization.dispalyName" placeholder="显示名称"/>
            </el-form-item>
            <el-form-item label="级别">
              <el-input v-model="organization.level" placeholder="级别"/>
            </el-form-item>
            <el-form-item label="网站">
              <el-input v-model="organization.webSite" placeholder="网站"/>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    deleteOrganization(id) {
      alert(id);
      this.$confirm('此操作将永久删除机构, 是否继续?', '提示', {
