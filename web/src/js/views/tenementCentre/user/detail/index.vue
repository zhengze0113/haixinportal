      ...
      <el-card class="box-card">
        <div slot="header" class="title">
          ...
          <!-- <el-button style="float: right; padding: 3px 0" type="text" @click="updateUser">
            <router-link
              :to="{path: '/tenementCentre/user/detail/userEdit/'+$route.params.id,query:{isRole:isRole,id:roleID}}"
              class="link"
              style="font-size:12px"
            >编辑</router-link>
          </el-button> -->
          <el-button v-if="isRole==true" style="float: right; padding: 3px 5px" type="text" @click="comeback()">
            <span
              class="link"
              style="font-size:12px"
            >返回</span>
...
export default {
  ...
  methods: {
    ...
    // 返回
    comeback() {
      location.href = '/#/tenementCentre/role/detail/' + this.roleID;
    },
    // 编辑用户
    updateUser() {
      //
