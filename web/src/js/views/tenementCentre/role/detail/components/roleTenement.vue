  ...
  <div>
    <el-row :gutter="20">
      <el-col :span="15" style="width: 100%;border-left: 3px solid #333;padding-left: 7px">
        <div class="grid-content bg-purple" style="color:#333;float:left;font-size:14px;">
          <b>租户信息</b>
        </div>
    ...
    <el-row class="details-left">
      <el-col :span="24">
        ...
        <el-col :span="16">
          <div class="grid-content bg-purple-light">{{tenant.tags}}</div>
        </el-col>
      </el-col>
    </el-row>
    <el-row class="details-left">
      <el-col :span="24">
        ...
        <el-col :span="16">
          <div class="grid-content bg-purple-light">{{tenant.description}}</div>
        </el-col>
      </el-col>
    </el-row>
    <el-row class="details-left">
