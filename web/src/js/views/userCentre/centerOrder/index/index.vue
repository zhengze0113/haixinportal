    ...
    <el-row style="padding:10px;background:#fff;margin-top:10px;">
      ...
      >
        ...
        <el-table-column label="操作" align="center" width="250">
          <template slot-scope="scope">
            <el-dropdown v-if="scope.row.statusName=='已完成'">
              <el-button size="mini">
                <el-link type="text" @click="particulars(scope.row)">查看</el-link><i class="el-icon-arrow-down el-icon--right"/>
              </el-button>
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item @click.native="changeConfiguration(scope.row.id,'RENEWAL')">
                  续费
                </el-dropdown-item>
                <el-dropdown-item v-if="scope.row.items.isSpace" @click.native="changeConfiguration(scope.row.id,'UPGRADE_CONFIGURATION')">
                  升级配置
                </el-dropdown-item>
                <el-dropdown-item v-if="scope.row.items.isSpace" @click.native="changeConfiguration(scope.row.id,'REDUCE_CONFIGURATION')">
                  降低配置
                </el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
            <el-dropdown v-else>
              <el-button size="mini" style="width:77px">
                <el-link type="text" @click="particulars(scope.row)">查看</el-link>
              </el-button>
              <el-dropdown-menu slot="dropdown"/>
            </el-dropdown>
          </template>
