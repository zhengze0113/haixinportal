        ...
        <close-card :show-arrow="true" title="服务订阅列表" icon="list">
          <div class="right">
            ...
            <el-button-group>
              ...
              <el-button @click="deletedSubscription()">
          ...
          >
            ...
            <el-table-column label="名称" align="center">
              <template slot-scope="scope">
                <router-link :to="{path: '/cloudService/serviceManage/serviceSubscription/detail/'+scope.row.id}" class="link">{{ scope.row.title }}</router-link>
              </template>
            </el-table-column>
