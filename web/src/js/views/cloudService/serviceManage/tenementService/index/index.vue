  ...
  <div>
    <el-row :gutter="20">
      <el-col :span="24" :offset="0"><div class="grid-content bg-purple">
        <close-card :show-arrow="true" title="租户服务列表" icon="list">
          <div class="right">
            <el-input
              v-model="searchInput"
              placeholder="请输入内容"
            ...
            <el-button-group>
              ...
              <el-button @click="deletedTenementService">
          ...
          >
            ...
            <el-table-column label="名称" align="center">
              <template slot-scope="scope">
                <!--<router-link :to="{path: '/cloudService/serviceManage/buyRecord/detail/'+scope.row.id}" class="link">{{ scope.row.title }}</router-link>-->
                {{ scope.row.title }}
              </template>
            </el-table-column>
