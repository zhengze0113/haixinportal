  ...
  <div>
    <el-row :gutter="20" class="primaryBackground">
      <el-col :span="24" :offset="0">
        <div class="grid-content bg-purple" style="padding:10px;">
          ...
          >
            <el-table-column prop="name" label="案例名称" align="center" />
            ...
            <!-- <el-table-column prop="cover.name" label="图片" align="center" /> -->
    ...
    >
      <el-form ref="ruleForm" :model="form">
        ...
        <el-form-item :label-width="formLabelWidth" label="案例描述">
          <el-col :span="24">
    ...
    <el-dialog
      ...
      width="65%"
    >
      <el-form ref="ruleForm_update" :model="form_update">
        <el-form-item
          :label-width="formLabelWidth"
          label="案例名称"
          prop="name"
        ...
        >
          <el-col :span="24">
            <el-input v-model="form_update.author" autocomplete="off" />
          </el-col>
        </el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button size="small" @click="dialogFormVisible_update = false"
          >取 消</el-button
        >
        <el-button
          type="primary"
          size="small"
          @click="updateForm('ruleForm_update')"
          >确 定</el-button
        >
      </div>
    </el-dialog>
...
import {
  selectapplication, // 查询应用案例
  getApplication, // 获取应用案例列表
  addsApplication, // 增加应用案例
  editApplication, // 修改应用案例
  deleteApplication, // 删除应用案例
  getapplicationcount
...
export default {
  ...
  methods: {
    ...
    async fetchData() {
      ...
      const res = await requestParams(getApplication, this.search);
      const res1 = await requestParams(getapplicationcount, params);
    ...
    async commitFrom(formName) {
      ...
      params.append("tags", this.form.tags);
      ...
      const res = await requestParams(addsApplication, params);
    ...
    // 获得类型数据
    async getTypeData() {
      const res = await requestParams(selectapplication);
      this.type = res;
    },
    // 删除文章
    deleteObject(id) {
      this.$confirm("此操作将永久删除该应用案例, 是否继续?", "提示", {
    ...
    editFrom() {
      ...
      params.append("__v", 0);
      editApplication(this.form_update.id, params).then(r => {
