<template>
  <div>
    <el-row style="padding:10px;background:#fff;margin-top:10px;border-bottom:1px solid #e6e6e6">
      <div class="grid-content bg-purple">
        <el-col :span="24">
          ...
          <div class="right">
            <el-button type="primary" size="mini" icon="el-icon-back" @click="comeback()">返回</el-button>
          </div>
        </el-col>
      </div>
    </el-row>
...
text-align: center;">
      ...
      <el-col :span="16" :offset="1">
        ...
        <el-col :spam="24" class="infoShow">
          ...
          <el-col :span="8">
            <el-col :span="8" class="xqColor">下&nbsp;&nbsp;单&nbsp;&nbsp;人：</el-col>
                ...
                <div class="table-wrap">
                  <el-table :data="list" size="small">
                    <el-table-column :show-overflow-tooltip="true" label="商品" align="center">
                      <template slot-scope="scope">{{ scope.row.items[0].name }}</template>
                    </el-table-column>
                    <el-table-column :show-overflow-tooltip="true" label="规格">
                      <template slot-scope="scope">
                        <div v-for="(item,index) in scope.row.items[0].params " :key="index">
                    ...
                    <el-table-column label="数量" align="center">
                      <template slot-scope="scope">{{ scope.row.items[0].amount }}</template>
                    </el-table-column>
              ...
              <div class="grid-content bg-purple">
                <div class="table-wrap">
                  <el-table :data="list1" size="small">
                    ...
                    <el-table-column :show-overflow-tooltip="true" label="原因" align="center">
...
export default {
  ...
  methods: {
    ...
    comeback() {
      this.$router.push({
        path: '/operatingCentre/flowApproval/processInstance'
      });
    },
