        ...
        <div class="grid-content bg-purple">
          <el-card class="box-card">
            <el-collapse v-model="activeName1" accordion>
              <el-collapse-item title="步骤11111：基本配置" name="1">
                <el-row :gutter="20">
                  ...
                  <el-col :span="22" :offset="1">
                    <el-collapse v-model="activeName" accordion>
                      <el-collapse-item name="1" title="创建">
                        <CreateFrom :creation="creation" :result="is" @getCreation="getCreationVal"/>
                      </el-collapse-item>
                      <el-collapse-item title="删除" name="2">
                        <DeleteForm :creation="deletion" :result="is" @getCreation="getDeleteVal"/>
                      </el-collapse-item>
                      <el-collapse-item title="变更" name="3">
                        <ModifiForm :creation="modification" :result="is" @getCreation="getModifiVal"/>
                      </el-collapse-item>
                    </el-collapse>
                  </el-col>
                </el-row>
            ...
            <el-row>
              <el-col :span="4" :offset="20" style="margin-top:20px;">
                ...
                <el-button :loading="loading" type="primary" size="small" @click="createCloudService()">创建</el-button>
              </el-col>
            </el-row>
          </el-card>
        </div>
...
import { createdCloudResource, getCloudServiceList } from '@/api/serviceOperating';
