...
import { getSKUList, deleteSKU, batchDeletesku, queryByIdCloudServiceSku } from '@/api/serviceOperating'; // deleteSKU,skudelete
...
export default {
  ...
  methods: {
    ...
    async fetchData() {
      ...
      await queryByIdCloudServiceSku(this.$route.params.id, this.search).then(res => {
