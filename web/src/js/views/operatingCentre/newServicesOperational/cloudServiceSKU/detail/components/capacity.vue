            ...
            <el-col :span="12">
              ...
              <el-col :span="23" :offset="1">
                ...
                >
                  ...
                  <el-col :span="23">
                    <el-input disabled v-model="cloudSkuFrom.name" placeholder="请输入关键字" />
                  </el-col>
                </el-form-item>
              </el-col>
              <el-col :span="23" :offset="1">
            ...
            <el-col :span="12">
              ...
              <el-col :span="23" :offset="1">
                ...
                >
                  ...
                  <el-col :span="23">
                    <el-select
                      v-model="cloudSkuFrom.serviceCode"
                      disabled
                      size="mini"
                      placeholder="请选择云服务"
                    >
...
export default {
  ...
  methods: {
    ...
    async fetchData() {
      ...
      const res2 = await requestParams(
        getResourcesSkuInfo,
        this.$route.params.id
      );
      this.cloudSkuFrom = res2.content;
      this.cloudSkuFrom.cpuCores = parseInt(this.cloudSkuFrom.cpuCores);
      this.cloudSkuFrom.memory = parseInt(this.cloudSkuFrom.memory);
      this.cloudSkuFrom.storage = parseInt(this.cloudSkuFrom.storage);
      this.resourcePrice();
    },
    ...
    createCloudService() {
      ...
      editskuspace(this.$route.params.id, this.cloudSkuFrom).then((r) => {
        if (r.code == 201) {
          this.$notify({
            message: r.message,
            type: "success",
