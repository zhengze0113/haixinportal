      ...
      <el-col :span="24" :offset="0">
        <div class="grid-content bg-purple">
          ...
          >
            ...
            <el-table-column label="记账资源" align="center">
              <template slot-scope="scope">{{scope.row.name }}</template>
            </el-table-column>
            <el-table-column label="SKU类型" width="80" align="center">
              <template slot-scope="scope">
                <span>{{category }}</span>
              </template>
            </el-table-column>
           ...
           <!-- <el-table-column label="操作"  align="center">
              <template slot-scope="scope">
                ...
                <el-button type="text" size="small" @click="dialogFormVisibledelete=true">设置</el-button>
