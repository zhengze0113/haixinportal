      ...
      <el-col :span="24" :offset="0">
        <div class="grid-content bg-purple">
          ...
          >
            ...
            <el-table-column label="资源名" width="100" align="center" fixed="left">
...
export default {
  ...
  methods: {
    ...
    addCloudResoucrce() {
      ...
      this.$router.push({
        path: `/operatingCentre/serviceOperating/cloudService/add/${this.$route.params.id}`
      });
    },
    handleClick(row) {
      console.log(row);
    ...
    editCloudResource(id) {
      this.$router.push({
        path: `/operatingCentre/serviceOperating/cloudService/edit/${id}`
      });
    },
