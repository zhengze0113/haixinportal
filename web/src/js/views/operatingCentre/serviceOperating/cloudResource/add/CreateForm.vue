                ...
                <el-row>
                  <el-col :span="8">
                    <el-form-item label="Key">
                      <el-input
                        v-model="form.parameters[i].paramKey"
                        disabled="disabled"
                      />
                    </el-form-item>
                  </el-col>
                  ...
                  <el-col :span="8">
                    <el-form-item label="是否内置">
                      <el-radio
                        v-model="form.parameters[i].reserved"
                        :label="true"
                        >是</el-radio
                      >
                      <el-radio
                  ...
                  <el-col :span="7" :offset="1">
                    <el-form-item label="是否编辑">
                      <el-radio
                        v-model="form.parameters[i].editable"
                        :label="true"
                        >是</el-radio
                      >
                      <el-radio
                  ...
                  <el-col :span="7" :offset="1">
                    <el-form-item label="是否必填">
                      <el-radio
                        v-model="form.parameters[i].required"
                        :label="true"
                        >是</el-radio
                      >
                      <el-radio
                  ...
                  <el-col :span="8">
                    <el-form-item label="类型">
                      <el-select
                        v-model="form.parameters[i].clazz"
                        style="width:92%;"
                      >
                  ...
                  <el-col :span="15" :offset="1">
                    <el-form-item label="标签">
                      <el-input
                        v-model="form.parameters[i].tags"
                        type="textarea"
                      />
                    </el-form-item>
                  </el-col>
          ...
          for (const key1 in data[key]) {
            if (typeof data[key][key1] === "string") {
              ...
              if (/^\$\{.*\}$/.test(data[key][key1])) {
                this.form.parameters.push({
                  paramKey: data[key][key1].substr(
                    2,
                    data[key][key1].length - 3
                  ),
                  clazz: "String",
                  name: "",
                  length: 0,
