            ...
            >
              ...
              <el-table-column label="角色名称" align="center">
                <template slot-scope="scope">
                  <router-link :to="{path: '/operatingCentre/tenementManage/role/detail/'+scope.row.id}" class="link">{{ scope.row.firstName }}</router-link>
                  <!--{{ scope.row.firstName }}-->
                </template>
              </el-table-column>
    ...
    <el-dialog :visible.sync="dialogFormVisible" title="新建" size="mini">
      <el-form :model="formInline" class="demo-form-inline" label-position="left" label-width="80px" >
        ...
        <el-form-item label="邮箱">
          <el-input v-model="formInline.user" placeholder="邮箱"/>
        </el-form-item>
