          ...
          >
            ...
            <el-table-column label="名称" width="60" align="center">
              <template slot-scope="scope">
                ...
                <router-link :to="{path: '/operatingCentre/tenementManage/tenementOrganization/detail/rolea/'+scope.row.id}" class="link">{{ scope.row.userName }}</router-link>
            ...
            <el-table-column label="租户信息" width="80" align="center">
              <template slot-scope="scope">王城</template>
            </el-table-column>
    ...
    <el-dialog :visible.sync="dialogFormVisible" title="新建" >
      <el-row :gutter="20">
        <el-col :span="20" :offset="3"><div class="grid-content bg-purple">
          <el-form :inline="true" :model="organization" label-width="100px" class="demo-form-inline" >
            ...
            <el-form-item label="用户组信息">
              <div style="width:200px;">用户组信息</div>
            </el-form-item>
          </el-form>
