  ...
  <div>
    ...
    <el-row class="details-left">
      <el-col :span="24" class="name-top">
        ...
        <el-col :span="16">
          <div class="grid-content bg-purple-light">{{ role.name }}</div>
        </el-col>
      </el-col>
    </el-row>
    <el-row class="details-left">
      <el-col :span="24">
        ...
        <el-col :span="16">
          <div class="grid-content bg-purple-light">{{ role.type }}</div>
        </el-col>
      </el-col>
    </el-row>
    <el-row class="details-left">
      <el-col :span="24">
        ...
        <el-col :span="16">
          <div class="grid-content bg-purple-light">{{ role.tags }}
        </div></el-col>
      </el-col>
    </el-row>
    <el-row class="details-left">
    ...
    <el-row class="details-left">
      <el-col :span="24">
        ...
        <el-col :span="16">
          <div class="grid-content bg-purple-light">{{ role.createTime | formatTime('yyyy-MM-dd hh:mm:ss') }}</div>
        </el-col>
      </el-col>
    </el-row>
    <el-row class="details-left">
      <el-col :span="24">
        ...
        <el-col :span="16">
          <div class="grid-content bg-purple-light">{{ role.lastModifiedTime | formatTime('yyyy-MM-dd hh:mm:ss') }}</div>
        </el-col>
      </el-col>
    </el-row>
  </div>
