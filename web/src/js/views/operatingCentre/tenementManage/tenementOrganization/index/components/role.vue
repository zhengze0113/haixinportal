        ...
        >
          <template slot-scope="scope">
            <router-link
              :to="{
                path:
                  '/operatingCentre/tenementManage/tenementOrganization/detail/rolea/' +
                  scope.row.id
              }"
              class="link"
            ...
            >
                ...
                :rules="[
                  {
                    ...
                    message: '请输入角色名称',
                    trigger: 'change'
                  },{pattern: /^[\u4e00-\u9fa5_a-zA-Z0-9]+$/, message: '名称中只能包含中文，英文字母和数字及下划线', trigger: 'change'},{ validator:checkName,trigger:'blur'}
                ]"
                label="名称"
                prop="name"
              >
                <el-input v-model="role.name" placeholder="请输入名称" show-word-limit maxlength="30"/>
              </el-form-item>
              <el-form-item
                :rules="[
                  {
              ...
              >
                <el-select
                  ...
                  style="width: 100%;"
                >
                  <el-option label="平台管理员" value="ROLE_ADMIN"/>
              ...
              <el-form-item label="标签">
                <el-input v-model="role.tags" placeholder="请填写标签" show-word-limit maxlength="100"/>
              </el-form-item>
      ...
      <el-row :gutter="20">
        <el-col :span="18" :offset="2">
          <div class="grid-content bg-purple">
            ...
            >
              <el-form-item
                :rules="[{required: true, message: '请输入角色名', trigger: 'blur'},{pattern: /^[\u4e00-\u9fa5_a-zA-Z0-9]+$/, message: '名称中只能包含中文，英文字母和数字及下划线', trigger: 'change'},{ validator:checkEditName,trigger:'blur'}]"
                label="名称"
                prop="name"
              >
                <el-input v-model="roleUpdata.name" show-word-limit maxlength="30"/>
              </el-form-item>
              <el-form-item
                :rules="[
                  {
              ...
              <el-form-item label="标签">
                <el-input v-model="roleUpdata.tags" show-word-limit maxlength="100"/>
              </el-form-item>
...
export default {
  ...
  methods: {
    ...
    async fetchData() {
      ...
      const res = await requestParams(getRoles, this.search, this.searchInput);
    ...
    searchRole() {
      searchByNameGetRoles(this.search, this.searchInput).then(res => {
        this.list = res.content.content;
      });
    },
    reset() {
