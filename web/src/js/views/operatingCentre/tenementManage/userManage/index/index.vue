<template>
  <div>
              ...
              <el-table-column
                ...
                <template slot-scope="scope">
                  <div class="table-operator">
                    <el-button type="text" size="small" @click="dialogFormPeizhi = true">
    ...
    <el-dialog :visible.sync="dialogFormPeizhi" title="配置">
      <el-form ref="form" :model="form" label-width="80px">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="dialogFormPeizhi = false">取 消</el-button>
        <el-button type="primary" @click="dialogFormPeizhi = false">立即创建</el-button>
      </div>
    </el-dialog>
  </div>
