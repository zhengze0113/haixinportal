            ...
            <div class="table-wrap">
              <el-table :data="orderList" size="small">
                ...
                <el-table-column label="操作" align="center">
                  <template slot-scope="scope">
                    <el-button size="small" @click="particulars(scope.row)">查看</el-button>
                  </template>
...
import { getOperatingSummaryBillDetails } from "@/api/billApi";
...
export default {
  ...
  methods: {
    ...
    getInfo() {
      getOperatingSummaryBillDetails(this.$route.params.id).then(r => {
