...
export default [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path:
          '/operatingCentre/tenementManage/tenementOrganization/detail/tenant/:id',
        name: '租户详情',
        hidden: true,
        meta: {
          title: '租户详情',
      ...
      {
        path:
          '/operatingCentre/tenementManage/tenementOrganization/detail/rolea/:id',
        name: '角色详情',
        hidden: true,
        meta: {
          title: '角色详情',
      ...
      {
        path:
          '/operatingCentre/tenementManage/tenementOrganization/detail/user/:id',
        name: '用户详情',
        hidden: true,
        meta: {
          title: '用户详情',
      ...
      {
        path:
          '/operatingCentre/tenementManage/tenementOrganization/detail/user/userEdit/:id',
        name: '用户编辑',
        hidden: true,
        meta: {
          title: '用户编辑',
      ...
      {
        path:
          '/operatingCentre/tenementManage/tenementOrganization/detail/organization/:id',
        name: '机构详情',
        hidden: true,
        meta: {
          title: '机构详情',
      ...
      {
        path:
          '/operatingCentre/tenementManage/tenementOrganization/detail/userGroup/:id',
        name: '用户组详情',
        hidden: true,
        meta: {
          title: '用户组详情',
