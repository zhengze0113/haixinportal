...
},
{
    ...
    children: [
        ...
        },
        {
            ...
            component: () =>
                import(
                    '@/views/operatingCentre/newServicesOperational/cloudService/index'
                ),
            children: [{
                path: '',
                hidden: true,
...

        {
            ...
            component: () =>
                import(
                    '@/views/operatingCentre/newServicesOperational/cloudServiceSKU/index'
                ),
            children: [{
                path: '',
                hidden: true,
            ...
            },
            {
                ...
                component: () =>
                    import(
                        '@/views/operatingCentre/newServicesOperational/cloudServiceSKU/add/index'
                    )
            }, {
                path: 'edit/:id',
                name: '编辑SKU',
                ...
                component: () =>
                    import(
                        '@/views/operatingCentre/newServicesOperational/cloudServiceSKU/edit/index'
                    )
            },
            ]
        },
        ...
        // },
        {
            ...
            component: () =>
                import(
                    '@/views/operatingCentre/newServicesOperational/capacityPricing/index'
                ),
            children: [{
                path: '',
                hidden: true,
            ...
            },
            {
                ...
                component: () =>
                    import(
                        '@/views/operatingCentre/newServicesOperational/capacityPricing/add/index'
                    )
            },
            {
                path: 'edit/:id',
                ...
                component: () =>
                    import(
                        '@/views/operatingCentre/newServicesOperational/capacityPricing/edit/index'
                    )
            },
            {
                path: 'detail/:id',
        ...
        },
        {
            ...
            component: () =>
                import(
                    '@/views/operatingCentre/newServicesOperational/attributeManagement/index'
                ),
            children: [{
                path: '',
                hidden: true,
            ...
            },
            {
                ...
                component: () =>
                    import(
                        '@/views/operatingCentre/newServicesOperational/attributeManagement/edit/index'
                    )
            },
            {
                path: 'detail/:id',
                ...
                component: () =>
                    import(
                        '@/views/operatingCentre/newServicesOperational/attributeManagement/detail/index'
                    )
            }
            ]
        }
