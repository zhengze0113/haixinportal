...
export default [{
...

    {
        ...
        children: [{
            ...
            component: () =>
                import ('@/views/tenementCentre/organization/index/index')
        }, {
            path: 'detail/:id',
            hidden: true,
            meta: {
            ...
            component: () =>
                import ('@/views/tenementCentre/organization/detail/index')
        }]
    },
    ...
    // import('@/views/tenementCentre/userGroup/detail/index')     }   ] },
    {
        ...
        children: [{
            ...
            component: () =>
                import ('@/views/tenementCentre/user/index/index')
        }, {
            path: 'detail/:id',
            hidden: true,
            meta: {
            ...
            component: () =>
                import ('@/views/tenementCentre/user/detail/index')
        }, {
            ...
            component: () =>
                import ('@/views/tenementCentre/user/add/index')
        }, {
            ...
            component: () =>
                import ('@/views/tenementCentre/user/detail/userEdit/index')
        }]
    }, {
        ...
        children: [{
            ...
            component: () =>
                import ('@/views/tenementCentre/role/index/index')
        }, {
            path: 'detail/:id',
            hidden: true,
            meta: {
            ...
            component: () =>
                import ('@/views/tenementCentre/role/detail/index')
        }]
    },
    // {
    ...
    // 账单
    {
        ...
        children: [{
                ...
                component: () =>
                    import ('@/views/tenementCentre/billCenter/billTable/index/index')
            }, {
                ...
                component: () =>
                    import ('@/views/tenementCentre/billCenter/billTable/detail/index')
            }
            //  {
            //   path: 'bookkeeping',
            //   meta: {
    ...
    // },
    {
        ...
        children: [{
            ...
            component: () =>
                import ('@/views/tenementCentre/flowApproval/index/index')
        }, {
            ...
            component: () =>
                import ('@/views/tenementCentre/flowApproval/detail/processExampleInfo')
        }]
    }, {
        ...
        children: [{
            ...
            component: () =>
                import ('@/views/tenementCentre/centerOrder/index/index')
        }, {
            ...
            component: () =>
                import ('@/views/tenementCentre/centerOrder/detail/index')
        }]
    }, {
