...
export default [
  {
    ...
    children: [{
      ...
      component: () => import('@/views/userCentre/userShoppingCart/index/index')
    }]
  },
  ...
  // },
  {
    ...
    children: [{
      ...
      component: () => import('@/views/userCentre/userAccount/basicInfo/index')
    },
    {
      path: 'editBasicInfo',
      hidden: true,
      ...
      component: () => import('@/views/userCentre/userAccount/edit/index')
    }
    ]
  },
  // {
  ...
  // },
  {
    ...
    children: [{
      ...
      component: () => import('@/views/userCentre/centerOrder/index/index')
    }, {
      path: 'detail/:id',
      name: '订单详情',
      hidden: true,
      ...
      component: () => import('@/views/userCentre/centerOrder/detail/index')
    }]
  },
  {
    ...
    children: [{
      ...
      component: () => import('@/views/userCentre/userServiceSubscription/index/index')
    }, {
      path: 'detail/:id',
      name: '账单详情',
      hidden: true,
      ...
      component: () => import('@/views/userCentre/userServiceSubscription/detail/index')
    }]
  },
  {
    ...
    children: [{
      ...
      component: () => import('@/views/userCentre/flowApproval/index/index')
    }, {
      ...
      component: () => import('@/views/userCentre/flowApproval/detail/processExampleInfo')
    }]
  }
